...
import com.densungkim.treasurer.http.{auth, transaction, user, Routes}
...
object Main extends App {
  ...
  private val transactionService =
    new TransactionServiceImpl(transactionRepository, userRepository)(ecProvider.database)

  private val authRoutes        = new auth.AuthRoutes(authService)
  private val userRoutes        = new user.UserRoutes(userService, authService)
  private val transactionRoutes = new transaction.TransactionRoutes(transactionService, authService)
